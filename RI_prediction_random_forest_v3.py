...
def main():
    ...
    plt.title('Feature Importance for Random Forest V3')
    plt.xlabel('Feature Groups')
    plt.ylabel('Importance')
    plt.xticks(rotation=45, ha='right')
    plt.grid(axis='y', alpha=0.7)
    plt.tight_layout()
    plt.savefig('feature_importance_random_forest_v3.png')
    plt.close()
    print("Grouped feature importance plot saved as 'feature_importance_random_forest_v3.png'")
