...
def main():
    ...
    plt.title('Feature Importance for XGBoost HKO')
    plt.xlabel('Features')
    plt.ylabel('Importance')
    plt.xticks(rotation=45, ha='right')
    plt.grid(axis='y', alpha=0.7)
    plt.tight_layout()
    plt.savefig('hko_feature_importance_xgboost.png')
    plt.close()
    print("Feature importance plot saved as 'hko_feature_importance_xgboost.png'")
